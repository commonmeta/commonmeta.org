...
and important influence on scholarly metadata. Unfortunately some decisions made more than 25 years ago
...
there are dates foof different granularity (e.g. `Summer 2017`), approximate dates, and date ranges. 
