...
commonmeta-ruby is a rewrite (and rename) of the [Briard Ruby Gem](https://github.com/front-matter/briard).
...
| [BibTex](http://en.wikipedia.org/wiki/BibTeX)                                                    | bibtex        | application/x-bibtex                   | ris     | yes     |
| [RIS](http://en.wikipedia.org/wiki/RIS_(file_format))                                            | ris           | application/x-research-info-systems    | ris     | yes     |
