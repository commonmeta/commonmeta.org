...
| [Citeproc JSON](https://citationstyles.org/)                                                     | citeproc      | application/vnd.citationstyles.csl+json | later | yes     |
...
Rewrite (and rename) of the [Briard Ruby Gem](https://github.com/front-matter/briard).
